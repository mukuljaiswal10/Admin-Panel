    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="overflow-x-auto rounded-xl shadow bg-[#0f1724] border border-gray-800">
        ...
        <div className="min-w-[900px] grid grid-cols-12 px-4 py-3 text-sm text-gray-300 font-semibold border-b border-gray-700 items-center">
          ...
          <div className="col-span-6">COLOR NAME</div>
        ...
        <div className="group relative min-w-[900px] grid grid-cols-12 px-4 py-5 text-gray-200 border-b border-gray-700 items-center hover:bg-[#0c1320] transition duration-200">
          ...
          <div className="col-span-6 font-medium">Red</div>
          <div className="col-span-2 text-sm">#er33rv</div>
