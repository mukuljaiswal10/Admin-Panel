    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <nav className="text-sm text-gray-600 mb-4" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-2">
          <li>
            <Link
              to="/dashboard"
              className="text-[blue] font-bold hover:underline cursor-pointer"
            >
              Home
            </Link>
          </li>
          <li className="text-gray-400">/</li>
          <li className="cursor-default">Enquirys</li>
          <li className="text-gray-400">/</li>
          <li className="text-black font-bold cursor-default">
      ...
      <div className="overflow-x-auto rounded-xl shadow bg-[#0f1724] border border-gray-800">
        ...
        <div className="group relative min-w-[900px] grid grid-cols-12 px-4 py-5 text-gray-200 border-b border-gray-700 items-center hover:bg-[#0c1320] transition duration-200">
          ...
          <div className="col-span-3 text-sm">xyz@gmail.com</div>
          <div className="col-span-2 text-sm">9876543210</div>
        ...
        <div className="group relative min-w-[900px] grid grid-cols-12 px-4 py-5 text-gray-200 border-b border-gray-700 items-center hover:bg-[#0c1320] transition duration-200">
          ...
          <div className="col-span-1 flex items-center justify-center">
            <span
              className="cursor-pointer select-none px-5 py-2 text-xs font-bold rounded-lg text-white bg-red-500 hover:bg-red-600 transition duration-200 hover:scale-[1.03] shadow-[0_0_10px_rgba(239,68,68,0.25)]"
              title="Deactive"
            >
              Deactive
            </span>
