    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <nav className="text-sm text-gray-600 mb-4" aria-label="Breadcrumb">
        <ol className="list-none p-0 inline-flex items-center space-x-2">
          ...
          <li className="text-black font-bold">View Material</li>
        </ol>
      </nav>
      {/* end */}
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-semibold text-gray-800">View Material</h2>
      ...
      <div className="overflow-x-auto rounded-xl shadow bg-[#0f1724] border border-gray-800">
        ...
        <div className="min-w-[900px] grid grid-cols-12 px-4 py-3 text-sm text-gray-300 font-semibold border-b border-gray-700 items-center">
          ...
          <div className="col-span-7">MATERIAL NAME</div>
