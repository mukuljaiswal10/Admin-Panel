    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <nav className="text-sm text-gray-600 mb-4" aria-label="Breadcrumb">
        <ol className="list-none p-0 inline-flex items-center space-x-2">
          ...
          <li className="text-gray-400">/</li>
          <li className="text-black font-bold">Add Sub Category</li>
        </ol>
      </nav>
        ...
        <div className="border rounded-md bg-white shadow-sm">
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              // For demo you could read form data here
            }}
          >
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      required
                      aria-required="true"
                      className="w-full rounded-md border border-gray-300 px-3 py-3 focus:outline-none focus:ring-2 focus:ring-blue-300 transition"
                    >
