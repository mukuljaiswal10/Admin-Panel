...
export default function ViewMaterial() {
  ...
  const rows = [
    { name: "Neil Sims", order: 1, active: true, img: "https://via.placeholder.com/28" },
  ];
      ...
      <form className="max-w-6xl mx-auto" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button type="button" className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition">
              Change Status
            </button>

            <button type="button" className="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition">
              Delete
            </button>
          </div>
        </div>
