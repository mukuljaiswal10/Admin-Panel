  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="overflow-x-auto rounded-xl shadow bg-[#0f1724] border border-gray-800">
        {/* Table header */}
        <div className="min-w-[900px] grid grid-cols-12 px-4 py-3 text-sm text-gray-300 font-semibold border-b border-gray-700 items-center">
        ...
        {/* Row 1 - Active */}
        <div className="group relative min-w-[900px] grid grid-cols-12 px-4 py-5 text-gray-200 border-b border-gray-700 items-center hover:bg-[#0c1320] transition duration-200">
          ...
          <div className="col-span-5 font-medium">Neil Sims</div>
          ...
          <div className="col-span-2 flex items-center justify-center">
            <span className="cursor-pointer select-none px-5 py-2 text-xs font-bold rounded-lg text-white bg-green-600 hover:bg-green-700 transition duration-200 hover:scale-[1.03] shadow-[0_0_10px_rgba(34,197,94,0.25)]">
              Active
            </span>
          </div>
        ...
        <div className="group relative min-w-[900px] grid grid-cols-12 px-4 py-5 text-gray-200 border-b border-gray-700 items-center hover:bg-[#0c1320] transition duration-200">
          ...
          <div className="col-span-2 flex items-center justify-center">
            <span className="cursor-pointer select-none px-5 py-2 text-xs font-bold rounded-lg text-white bg-rose-600 hover:bg-rose-700 transition duration-200 hover:scale-[1.03] shadow-[0_0_10px_rgba(244,63,94,0.22)]">
              Deactive
            </span>
          </div>

          <div className="col-span-1 flex items-center justify-center">
            <Link to={"/category/edit/2"}>
              <button
                type="button"
                className="cursor-pointer select-none w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-700 hover:shadow-[0_0_18px_rgba(59,130,246,0.35)] active:scale-[0.98] transition duration-200 flex items-center justify-center text-white"
                aria-label="Edit"
