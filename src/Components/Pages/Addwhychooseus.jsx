      ...
      <div className="max-w-6xl mx-auto">
        <div className="border rounded-md bg-white shadow-sm">
          ...
          <form
            className="p-6"
            onSubmit={(e) => {
              // Let browser handle native validation messages.
              if (!e.currentTarget.checkValidity()) {
                e.preventDefault();
                e.stopPropagation();
              } else {
                e.preventDefault(); // remove when hooking backend
                // optional: show a toast / message here when integrated
              }
            }}
          >
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      aria-required="true"
                      className="w-full rounded-md border border-gray-300 px-4 py-3 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent resize-none transition hover:shadow-sm"
                    />
                  </div>
                </div>
              </div>
