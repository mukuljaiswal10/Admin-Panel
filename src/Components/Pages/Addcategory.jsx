    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="border rounded-md bg-white shadow-sm">
          ...
          {/* Everything inside form as requested */}
          <form
            className="p-6"
            onSubmit={(e) => {
              // Let browser show native validation messages; prevent reload for demo.
