    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <nav className="text-sm text-gray-600 mb-4" aria-label="Breadcrumb">
        <ol className="list-none p-0 inline-flex items-center space-x-2">
          ...
          <li className="text-black font-bold">View FAQ</li>
        </ol>
      </nav>
      {/* end */}
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-semibold text-gray-800">View Faq</h2>
      ...
      <div className="overflow-x-auto rounded-xl shadow bg-[#0f1724] border border-gray-800">
        {/* Table header */}
        <div className="min-w-[1050px] grid grid-cols-12 px-4 py-3 text-sm text-gray-300 font-semibold border-b border-gray-700 items-center">
        ...
        {/* Row 1 */}
        <div className="group relative min-w-[1050px] grid grid-cols-12 px-4 py-5 text-gray-200 border-b border-gray-700 items-start hover:bg-[#0c1320] transition duration-200">
          ...
          <div className="col-span-4 font-medium leading-6">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit.
          </div>

          <div className="col-span-4 text-sm text-gray-300 leading-6">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit.
          ...
          <div className="col-span-1 text-sm pt-1">1</div>
        ...
        <div className="group relative min-w-[1050px] grid grid-cols-12 px-4 py-5 text-gray-200 border-b border-gray-700 items-start hover:bg-[#0c1320] transition duration-200">
          ...
          <div className="col-span-4 font-medium leading-6">Neil Sims</div>

          <div className="col-span-4 text-sm text-gray-300 leading-6">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Recusandae
            debitis hic, voluptate ullam optio laboriosam, delectus, reiciendis
            esse vitae eos nostrum? Praesentium provident doloremque debitis,
            fuga quod quidem doloribus. Aliquid.
          </div>
          ...
          <div className="col-span-1 flex items-center justify-center pt-1">
            <span
              className="cursor-pointer select-none px-5 py-2 text-xs font-bold rounded-lg text-white bg-rose-600 hover:bg-rose-700 transition duration-200 hover:scale-[1.03] shadow-[0_0_10px_rgba(244,63,94,0.25)]"
              title="Deactivate"
            >
              Deactive
            </span>
